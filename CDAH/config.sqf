...
CDAH_option_craftTimer 		= false; 	// if is "false", u 'DON'T' use the Timecrafting. If you want to use the CDAH_craftTimer please install "REALTIME RESTARTER" http://www.exilemod.com/topic/17916-realtime-restarts/#comment-123819 Thx to "Michael Cullen".
